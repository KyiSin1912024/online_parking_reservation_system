...
if (isset($_GET["space_type_id"])) {
    $space_type_id = $_GET["space_type_id"];
}
$space_type = get_space_type_by_id($mysqli, $space_type_id);
$space_type_name = $space_type['space_type_name'];
$charge_price= $space_type['charge_price'];
$space_type_name_err = "";
$validate = true;
...
if(isset($_POST["update"])) {
    ...
    if($validate) {
        $result = update_space_type($mysqli, $space_type_id, $space_type_name, $charge_price);
        if($result) {
            $success = true;
        } else {
            $invalid = true;
