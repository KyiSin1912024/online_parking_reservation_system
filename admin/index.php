...
$parking_space = get_parking_spaces_count($mysqli);
$customer = get_customer_count($mysqli);
$today_booking = get_booking_count_for_today($mysqli);
$income = get_total_income($mysqli);
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $parking_space['space_count'] ?></h6>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $today_booking['booking_count']?></h6>
                    </div>
                  </div>
                </div>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $income['total_amount'] ?> MMK</h6>
                    </div>
                  </div>
                </div>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo $customer['cus_count'] ?></h6>
                    </div>
                  </div>
                </div>
